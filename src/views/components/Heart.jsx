    ...
    return(
        <div>
            <input type="checkbox" id="coracao"/>
                <label className="icone" htmlFor="coracao">
                    <svg width="100" height="100" viewBox="0 0 24 22" fill="none" className="heart"
                        ...
                        <path
                            ...
                            stroke="#D73B3B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </label>
        </div>
    )
